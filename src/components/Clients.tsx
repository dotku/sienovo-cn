...
const Clients = () => {
  ...
  const testimonials = [
    {
      content:
        "信迈智科 Sienovo 的军事信息化解决方案大幅提升了我们的指挥效率和情报分析能力，是我们信息化建设的重要合作伙伴。",
      author: "某军区信息化部门负责人",
      role: "少将",
    },
    {
      content:
        "智能辅助判决系统帮助我们提高了案件处理效率，减轻了法官的工作负担，同时保证了判决的公正性和一致性。",
      author: "某高级人民法院",
      role: "院长",
    },
    {
      content:
        "医院智慧系统的实施使我们的医疗服务水平得到了显著提升，特别是在疫情期间，远程医疗平台发挥了重要作用。",
      author: "某三甲医院",
      role: "院长",
    },
  ];
